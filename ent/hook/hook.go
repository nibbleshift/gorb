...
// The BenchFunc type is an adapter to allow the use of ordinary
// function as Bench mutator.
type BenchFunc func(context.Context, *ent.BenchMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BenchFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BenchMutation); ok {
		return f(ctx, mv)
	}
