...
func N(v int) predicate.BenchResult {
	return predicate.BenchResult(sql.FieldEQ(FieldN, v))
}

// NsPerOp applies equality check predicate on the "NsPerOp" field. It's identical to NsPerOpEQ.
func NsPerOp(v float64) predicate.BenchResult {
	return predicate.BenchResult(sql.FieldEQ(FieldNsPerOp, v))
}

// AllocedBytesPerOp applies equality check predicate on the "AllocedBytesPerOp" field. It's identical to AllocedBytesPerOpEQ.
func AllocedBytesPerOp(v uint64) predicate.BenchResult {
	return predicate.BenchResult(sql.FieldEQ(FieldAllocedBytesPerOp, v))
}

// AllocsPerOp applies equality check predicate on the "AllocsPerOp" field. It's identical to AllocsPerOpEQ.
func AllocsPerOp(v uint64) predicate.BenchResult {
	return predicate.BenchResult(sql.FieldEQ(FieldAllocsPerOp, v))
}

// MBPerS applies equality check predicate on the "MBPerS" field. It's identical to MBPerSEQ.
...
// AllocedBytesPerOpIn applies the In predicate on the "AllocedBytesPerOp" field.
...
// AllocedBytesPerOpNotIn applies the NotIn predicate on the "AllocedBytesPerOp" field.
...
// AllocedBytesPerOpGT applies the GT predicate on the "AllocedBytesPerOp" field.
func AllocedBytesPerOpGT(v uint64) predicate.BenchResult {
	return predicate.BenchResult(sql.FieldGT(FieldAllocedBytesPerOp, v))
}

// AllocedBytesPerOpGTE applies the GTE predicate on the "AllocedBytesPerOp" field.
...
// AllocedBytesPerOpLT applies the LT predicate on the "AllocedBytesPerOp" field.
func AllocedBytesPerOpLT(v uint64) predicate.BenchResult {
	return predicate.BenchResult(sql.FieldLT(FieldAllocedBytesPerOp, v))
}

// AllocedBytesPerOpLTE applies the LTE predicate on the "AllocedBytesPerOp" field.
